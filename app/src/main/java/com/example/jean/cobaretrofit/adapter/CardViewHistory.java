package com.example.jean.cobaretrofit.adapter;
...
public class CardViewHistory extends RecyclerView.Adapter<CardViewHistory.CardViewHolder> {
    private List<Club> clubList;
    private Context context;

    public CardViewHistory(List<Club> clubList , Context context) {
    ...
    public class CardViewHolder extends RecyclerView.ViewHolder {
        ...
        public CardViewHolder(@NonNull final View itemView) {
            ...
            mImageIcon = (ImageView) itemView.findViewById(R.id.imgIcon);
